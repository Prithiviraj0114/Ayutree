...
import { House, Package, ShoppingBag, Users, ChartBar, SignOut, Tag, Star, FolderSimple } from "@phosphor-icons/react";
import { useAuth } from "../../contexts/AuthContext";

const links = [
  { to: "/admin", label: "Dashboard", icon: ChartBar, end: true },
  { to: "/admin/products", label: "Products", icon: Package },
  { to: "/admin/categories", label: "Categories", icon: FolderSimple },
