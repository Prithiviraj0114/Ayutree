      ...
      <div className="grid md:grid-cols-2 gap-8 md:gap-16">
        ...
        <div className="md:pt-6">
          ...
          <div className="mt-8 flex flex-col sm:flex-row sm:items-center gap-4">
            <div className="flex items-center border border-[#E8E1D5] self-start sm:self-auto">
              <button data-testid="qty-decrement" onClick={() => setQty((q) => Math.max(1, q - 1))} className="w-12 h-12 flex items-center justify-center"><Minus size={14} /></button>
              <span data-testid="qty-value" className="w-12 text-center text-sm">{qty}</span>
              <button data-testid="qty-increment" onClick={() => setQty((q) => q + 1)} className="w-12 h-12 flex items-center justify-center"><Plus size={14} /></button>
            </div>
