  ...
  return (
    <div data-testid="login-page" className="min-h-[80vh] grid md:grid-cols-2">
      <div className="hidden md:block relative">
        <img src="https://images.pexels.com/photos/6811712/pexels-photo-6811712.jpeg" alt="" className="absolute inset-0 w-full h-full object-cover" />
      ...
      <div className="flex items-center justify-center px-6 md:px-16 py-16">
        <div className="w-full max-w-md">
          ...
          <button data-testid="google-login-btn" onClick={loginWithGoogle} className="mt-8 w-full flex items-center justify-center gap-3 py-3.5 border border-[#1A3B32] text-[#1A3B32] hover:bg-[#1A3B32] hover:text-white transition-colors text-xs uppercase tracking-[0.2em]">
          ...
          <p className="mt-6 text-[11px] text-[#9AA6A0]">Admin? Use admin@ayutree.com</p>
          <p className="mt-2 text-xs"><Link to="/forgot-password" data-testid="forgot-link" className="text-[#1A3B32] underline underline-offset-4">Forgot password?</Link></p>
        </div>
      </div>
    </div>
  );
